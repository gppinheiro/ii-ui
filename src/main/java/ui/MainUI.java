...
public class MainUI {
    ...
    private void createShowTable1() {
        try {
            ...
            ShowTable1.setModel(new DefaultTableModel(data,new String[]{"Nº de Ordem","Peça Inicial","Peça Final", "Quantidade"}));
    ...
    private void createTable() {
        Object[][] data={
                {"Num de Peças",0,0,0,0,0,0,0,0},
                {"Tempo"}
        };

        showTable.setModel(new DefaultTableModel(data, new String[]{"Peças", "M1", "M2", "M3", "M4", "M5", "M6", "M7", "M8"} ) );
